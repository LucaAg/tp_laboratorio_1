...
int menu()
{
	...
	printf("     2. Reiniciar lista.\n");
	printf("     3. Alta de empleado\n");
	printf("     4. Modificar datos de empleado\n");
	printf("     5. Baja de empleado\n");
	printf("     6. Listar empleados\n");
	printf("     7. Ordenar empleados\n");
	printf("     8. Eliminar empleado/a mas barato.\n");
	printf("     9. Crear una sublista.\n");
	printf("     10. Reemplazar empleado/a\n");
	printf("     11. Agregar empleado/a en el indice indicado\n");
