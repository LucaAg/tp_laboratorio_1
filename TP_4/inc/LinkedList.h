...
LinkedList* ll_filter(LinkedList* this, int (*pFunc) (void*) ); //recibe un elemento y devuelve 1 o 0, recorre un linkedList, hace un get de cada elemento
//y lo vuelca en la funcion dentro de filter. Esa funcion devuelve 1 o 0.
// ejemplo le paso una funcion que muetra los varones, y filter devuelve una lista nuevo de solo varones.
